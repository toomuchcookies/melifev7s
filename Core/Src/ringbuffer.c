 ...
 *      Author:
 *      Originally: https://github.com/kb3gtn/STM32_UART_ECHO/blob/master/Src/ringbuffer.c
 */

#ifndef SRC_RINGBUFFER_C_
#define SRC_RINGBUFFER_C_
